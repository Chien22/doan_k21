...
public class Pieza extends Actor {
	...
	public int valor;// esta pieza la hice privada porque cuando cambio su valor tambien tengo que
						// cambiar la imagen de esta pieza
	...
	public void moveToPosition(int pos) {
		...
		addAction(Actions.moveTo(mapPosiciones.get(posicion).x, mapPosiciones.get(posicion).y, .085f));
	}
